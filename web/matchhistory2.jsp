...
<html>
    ...
    <body>
        ...
        <tr>
            ...
            <td><%=hwpn%></td>
            <td><%=mom%></td>
            <td><a href="edit3.jsp?idd=<%=id%>"><img src="Images/edit.png" width="50px" height="50px"/></a></td>
            <td><a href="delete3.jsp?idd=<%=id%>"><img src="Images/delete.png" width="50px" height="50px"/></a></td>
        </tr>
        <%
                }
                out.println("</table>");
